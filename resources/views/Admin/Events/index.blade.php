                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            @else
                                                ...
                                                <form action="{{ route('admin.events.force-delete', $event->id) }}" method="POST" class="d-inline" data-confirm="Permanently delete this event? This cannot be undone." data-confirm-action="Permanent Delete">
                                                    @csrf
                                                    @method('DELETE')
