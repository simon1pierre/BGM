                ...
                <form method="POST" id="campaignForm" action="{{ route('admin.campaigns.store') }}" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="target_type" class="form-select">
                            <option value="all" @selected(old('target_type') === 'all')>All Active Subscribers</option>
                            <option value="selected" @selected(old('target_type') === 'selected')>Selected Subscribers</option>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="target_emails" value="{{ old('target_emails') }}" class="form-control" placeholder="user1@example.com, user2@example.com">
                    ...
                    <div class="col-12">
                        ...
                        <div class="border rounded p-3" style="max-height: 260px; overflow-y: auto;">
                            <div class="row">
                                ...
                                @empty
                                    <div class="text-muted">No active subscribers found.</div>
                                @endforelse
                            </div>
                        </div>
                    </div>
