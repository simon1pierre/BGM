                    ...
                    <form method="POST" action="{{ route('admin.videos.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="speaker" value="{{ old('speaker') }}" class="form-control" list="preachersList" placeholder="Start typing preacher name..." autocomplete="off">
                                ...
                                <div class="d-flex gap-2">
                                    <select name="video_series_id" class="form-select">
                                        ...
                                        @foreach ($videoSeries as $seriesOption)
                                            <option value="{{ $seriesOption->id }}" @selected(old('video_series_id') == $seriesOption->id)>{{ $seriesOption->title }}</option>
                                        @endforeach
                                    </select>
