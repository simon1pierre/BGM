...
@section('contents')
    <div class="nxl-content">
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Add Devotional</h5>
                </div>
                <ul class="breadcrumb">
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.devotionals.store') }}" enctype="multipart/form-data">
                        @csrf
                        @php
                            $translations = ['en' => null, 'fr' => null, 'rw' => null];
                        @endphp
